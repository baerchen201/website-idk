...
window.addEventListener("load", () => {
    ...
    let crash_btn = document.getElementById("crash");
    ...
    crash_btn.addEventListener("click", () => {
        ...
        let processor = {
            ...
            doLoad: function (video, canvas, _buffer) {
            ...
            timerCallback: function (video, context, buffer) {
            ...
            computeFrame: function (video, context, buffer) {
                let width = video.videoWidth / 2, height = video.videoHeight / 2;
                if (!width || !height)
